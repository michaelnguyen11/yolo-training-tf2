...
def MobileNetV3(stack_fn,
    ...
    # Raises
        ValueError: in case of invalid models type, argument for `weights`,
...
if __name__ == '__main__':
    ...
    # models = MobileNetV3Large(include_top=False, input_shape=(416, 416, 3), weights='imagenet', alpha=1.0)
