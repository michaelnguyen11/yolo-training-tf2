...
Tests comparing this models to the existing Tensorflow models can be
...
from tensorflow.keras.layers import Conv2D, DepthwiseConv2D, Dense, GlobalAveragePooling2D, GlobalMaxPooling2D, Flatten, \
    Softmax, Dropout, ZeroPadding2D
...
def MobileNetV2(input_shape=None,
    ...
    # Arguments
        input_shape: optional shape tuple, to be specified if you would
            like to use a models with an input img resolution that is not
            (224, 224, 3).
...
if __name__ == '__main__':
    ...
    # models = MobileNetV2(include_top=True, input_shape=(224, 224, 3), weights='imagenet', alpha=1.0)
