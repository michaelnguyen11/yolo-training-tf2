...
from tensorflow.keras.layers import Conv2D, DepthwiseConv2D, Dense, MaxPool2D, GlobalMaxPooling2D, \
...
if __name__ == '__main__':
    ...
    # models = EfficientNetB0(include_top=False, input_shape=(416, 416, 3), weights='imagenet')
