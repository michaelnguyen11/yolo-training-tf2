...
from yolov5.postprocess_np import yolov5_postprocess_np
...
def yolo_predict_tflite(interpreter, image, anchors, num_classes, conf_threshold, elim_grid_sense, v5_decode):
    ...
    pred_boxes, pred_classes, pred_scores = yolov5_postprocess_np(prediction, image_shape, anchors, num_classes,
