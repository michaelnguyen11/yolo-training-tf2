...
def yolov5_mobilenetv1_body(inputs, num_anchors, num_classes, alpha=1.0):
    ...
    f1 = yolov5_spp_neck(f1, int(1024 * alpha))
...
def yolov5_lite_mobilenetv1_body(inputs, num_anchors, num_classes, alpha=1.0):
