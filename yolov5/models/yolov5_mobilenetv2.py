...
from yolov5.models.layers import yolov5_predictions, yolov5_lite_predictions, yolov5_spp_neck


def yolov5_mobilenetv2_body(inputs, num_anchors, num_classes, alpha=1.0):
    ...
    f1 = yolov5_spp_neck(f1, int(1280 * alpha))
    ...
    y1, y2, y3 = yolov5_predictions((f1, f2, f3), (f1_channel_num, f2_channel_num, f3_channel_num), num_anchors,
                                    num_classes, depth_multiple, width_multiple, with_spp=False)

    return Model(inputs, [y1, y2, y3])


def yolov5_lite_mobilenetv2_body(inputs, num_anchors, num_classes, alpha=1.0):
    ...
    y1, y2, y3 = yolov5_lite_predictions((f1, f2, f3), (f1_channel_num, f2_channel_num, f3_channel_num), num_anchors,
                                         num_classes, depth_multiple, width_multiple, with_spp=False)
